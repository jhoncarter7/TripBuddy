...
const SearchBar: React.FC<searchBarInter> = ({navigate}) => {
  ...
  return (
    <div className='absolute inset-0 top-7/12 item flex justify-center h-10' >
       ...
       <input type="text"  className=' border-4 border-x-[#B0FF53] border-t-[#C7FF53] border-b-[#99FF53] rounded-2xl p-3 px-12 bg-white w-sm ' placeholder='Search countries, cities'  onClick={navigate}/>
